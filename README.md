...
Java is my strongest foundation right now. I have been using it through college work, JavaFX desktop apps, object-oriented design, simulations, file handling, and interface logic.

I also like building projects that push me into new areas. My portfolio includes full-stack web apps, AI-assisted study and productivity tools, dashboards, real-time chat and video features, and desktop apps with cleaner user flows.

<table>
  <tr>
    <td width="50%" valign="top">
      <h3>What I enjoy building</h3>
      <p>Useful apps with clear interfaces, practical workflows, and features that make everyday tasks easier.</p>
    </td>
    <td width="50%" valign="top">
      <h3>What I am looking for</h3>
      <p>Internships, entry-level programming roles, project feedback, and chances to learn from experienced developers.</p>
    </td>
  </tr>
</table>
...
- Growing my Java, JavaFX, FXML, and object-oriented design skills
- Practicing full-stack development with React, Next.js, Node.js, and Express
- Exploring real-time features with SignalR, WebRTC, and Socket.IO
- Adding thoughtful AI-assisted features with the Gemini API
- Improving how I design, test, explain, and deploy projects
...
<p>
  ...
  <img src="https://img.shields.io/badge/SQL-334155?style=flat-square&logo=sqlite&logoColor=white" alt="SQL">
</p>
...
<p>
  ...
  <img src="https://img.shields.io/badge/FXML-475569?style=flat-square&logo=openjdk&logoColor=white" alt="FXML">
...
<p>
  ...
  <img src="https://img.shields.io/badge/Firebase_Storage-FFCA28?style=flat-square&logo=firebase&logoColor=111827" alt="Firebase Storage">
  ...
  <img src="https://img.shields.io/badge/Open_Library_API-1F2937?style=flat-square&logo=bookstack&logoColor=white" alt="Open Library API">
  <img src="https://img.shields.io/badge/CSV-16A34A?style=flat-square&logo=files&logoColor=white" alt="CSV">
</p>

## Connect

The best place to see the full project list is my portfolio.
